...
export default function PaymentSuccessPage() {
  ...
  return (
    <main className="min-h-[calc(100vh-120px)] bg-gradient-to-br from-blue-500 via-purple-500 to-fuchsia-500 flex items-center justify-center px-4 py-16">
      <div className="max-w-xl w-full bg-white/10 backdrop-blur rounded-3xl border border-white/20 shadow-2xl p-10 text-center text-white">
        ...
        <h1 className="text-4xl font-semibold mb-2">Оплату успішно завершено!</h1>
        {orderId ? (
          <p className="text-white/80 mb-6">
            Замовлення <span className="font-semibold">#{orderId}</span> сплачено.
          </p>
        ) : (
