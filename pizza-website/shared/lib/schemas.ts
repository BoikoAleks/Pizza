...
export const productFormSchema = z.object({
    ...
    items: z.array(z.object({
        ...
        size: z.union([z.number(), z.null()]).optional().transform(val => (val == null ? undefined : Number(val))),
        pizzaType: z.union([z.number(), z.null()]).optional().transform(val => (val == null ? undefined : Number(val))),
